 ...
 */
public class LightViewLeft extends ImageView {

    private GradientDrawable bgShape = new GradientDrawable();

    public LightViewLeft(Context context) {
        super(context);
    }

    public LightViewLeft(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.bgShape = (GradientDrawable)this.getBackground();
    }

    public LightViewLeft(Context context, AttributeSet attrs, int defStyleAttr) {
